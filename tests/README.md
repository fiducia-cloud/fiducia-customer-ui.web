...
- `customer-standalone.test.mjs` — boots this repo's own `dist/` with Vite
  preview and preserves regression evidence for the retired standalone login,
  API-key, and security shell without claiming production authority.
